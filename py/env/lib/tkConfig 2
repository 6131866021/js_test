...
# installed.
TK_PREFIX='/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/sasinatthiwathittayanuphap/Desktop/Project/js/JavaScript_Test/py/env/lib/libtkstub8.6.a'
